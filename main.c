...
int		main(void)
{
	...
	long double d = 99999999999999999999999999947983278948423424377598437057435726529395329563672359130450316516051606536056205610601650361465813784387846536056205.4L;
	printf("%.50Lf\n", d);
	while ((int)fmodl(d, 2.0) != 1 && d > 1.0)
	{
		d /= 2.0;
		printf("%.50Lf\n%.50Lf\n", d, fmodl(d, 2.0));
	}
	...
	ret1 =    printf("|%100.Lf|\n", 1234567812345678123456781234567812345678123456781234567812345678.1L);
	ret2 = ft_printf("|%100.Lf|\n", 1234567812345678123456781234567812345678123456781234567812345678.1L);
